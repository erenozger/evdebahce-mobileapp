...
final allPlants = [
  PlantsModel(
    plant_Name: 'Domates',
    plant_Picture: 'assets/images/Domates.png',
    plant_Description:
  ...
  PlantsModel(
    plant_Name: 'Maydanoz',
    plant_Picture: 'assets/images/Maydanoz.png',
    plant_Description:
  ...
  PlantsModel(
    plant_Name: 'Marul',
    plant_Picture: 'assets/images/Marul.png',
    plant_Description:
  ...
  PlantsModel(
    plant_Name: 'Biber',
    plant_Picture: 'assets/images/Biber.png',
    plant_Description:
  ...
  PlantsModel(
    plant_Name: 'Semizotu',
    plant_Picture: 'assets/images/Semizotu.png',
    plant_Description:
